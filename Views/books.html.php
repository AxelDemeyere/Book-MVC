<?php require 'partials/header.html.php';?>
    ...
    <div class="max-w-5xl mx-auto px-3">
        <div class="text-center mb-8">
            <a class="bg-gray-900 px-4 py-2 text-white inline-block rounded hover:bg-gray-700 duration-200" href="/books/new">
                Créer un livre
            </a>
        </div>
                    ...
                    <div class="flex flex-col justify-between h-full">
                        <a href="/book/<?= $book['id']; ?>">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex justify-arounditems-center">
                                    <p class="text-lg font-bold"><?= $book['price'] - ($book['price'] * ($book['discount']/100)); ?>€</p>
                                    <?php if ($book['discount'] > 0) { ?>
                                    <p class="text-xs font-bold">-<?= $book['discount']; ?>%
                                    <span class="line-through"><?= $book['price'] ?>€</span></p>
                                    <?php } ?>
                                </div>
                        ...
                        <div class="text-center">
                            ...
                            <a class="bg-red-700 px-4 py-2 text-white inline-block rounded hover:bg-red-500 duration-200 mb-4" href="/book/delete/<?= $book['id'] ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
